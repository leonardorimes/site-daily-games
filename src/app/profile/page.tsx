...
export const metadata: Metadata = {
  ...
  description: "Perfil Leonardo Rimes",
};
      ...
      <Container>
        <section className="mt-8 mb-6 flex flex-col items-center justify-between relative gap-3 sm:flex-row">
          <div className="w-full flex items-center gap-4 text-lg flex-col sm:flex-row justify-center sm:justify-normal">
            <Image
              src="/user.png" // Caminho direto a partir da raiz de public
              alt="Imagem perfil do usuario"
              width={224} // necessário com `next/image` se não usar layout="fill"
              height={224}
              className="rounded-full w-56 h-56 object-cover"
            />

            <h1 className="font-bold text-2xl">Leonardo Rimes</h1>
          </div>
